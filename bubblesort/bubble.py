...
t4a=open("length4a.txt", 'r', encoding="utf-16")
t4b=open("length4b.txt", 'r')
t4c=open("length4c.txt", 'r')
t5a=open("length5a.txt", 'r', encoding="utf-16")
t5b=open("length5b.txt", 'r', encoding="utf-16")
t5c=open("length5c.txt", 'r', encoding="utf-16")
...
def bubble(arr):
    ...
    while j<n-1:
        i=int(0)
        while i<n-1-1:
            while int(a[i])>int(a[i+1]) and i>=0:
                j=int(a[i])
                a[i]=a[i+1]
                a[i+1]=j
                i-=1
